...
<main class="bg-main main__content">
    ...
    <section class="most_requested mb-5 position-relative">
      ...
      >
        <img
          src="{{ asset('imgs') }}/istockphoto-1421941487-612x612-removebg-preview 1.png"
          alt="prize image"
        />
        <img
          src="{{ asset('imgs') }}/istockphoto-1421941487-612x612-removebg-preview 5.png"
          alt="prize image"
        />
      </div>
                  ...
                  <div class="card-body px-2 py-4">
                    ...
                    <p class="card-text text-black-50 fs-12">
                      <span class="text-black text-opacity-25 fs-14"
                        ><img src="{{ asset('imgs') }}/houseico.svg" alt="icon" /> Shop :
                        kareem evee</span
                      >
          ...
          <div class="card-body rounded-5 px-4 py-2 bg-white">
            ...
            >
              ...
              <span class="d-flex align-items-center bg_rating p-1 rounded-5"
                ><img src="{{ asset('imgs') }}/Star_1.svg" alt="rating" class="me-1" />
                <span class="rating__number text-white fs-12 fw-light"
                  >4.9</span
                >
              </span>
